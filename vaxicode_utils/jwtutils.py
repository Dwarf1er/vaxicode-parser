...
def decode_and_print_header(encoded_JWT:str):
    ...
    decoded_header = jsonutils.sanitize_JSON(decoded_header)
    decoded_header_formatted = jsonutils.format_JSON(decoded_header)
...
def decode_and_print_body(encoded_JWT:str):
    ...
    # sanitizing the JSON data to pretty print it
    decoded_body = jsonutils.sanitize_JSON(decoded_body)
    decoded_body_formatted = jsonutils.format_JSON(decoded_body)
